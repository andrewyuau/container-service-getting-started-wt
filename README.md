...
1. After finishing the first course and receiving the badge, send me an email (andrewyu at au.ibm.com) with a screenshot and I will grant you permissions and send you a kubeconfig file for an upgraded cluster for the Istio and Knative courses.
